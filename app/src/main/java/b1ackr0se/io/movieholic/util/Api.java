...
public class Api {
    ...
    public static final String MOVIE_IMAGES = BASE_URL + "/movie/%s/images?api_key=" + API_KEY;
    public static final String TV_IMAGES = BASE_URL + "/tv/%s/images?api_key=" + API_KEY;
